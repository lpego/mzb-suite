...
streamlit_log = {"app_main_supervised_skeletons_finetune": {"start_time": datetime.datetime.now()}}
...
with col2:
    if st.session_state.config_folder is not False:
        ...
        streamlit_log["app_main_supervised_skeletons_finetune"]["config_file"] = config_file


input_dir = st.session_state.get("input_dir", None)
input_button = st.button("Select path with images for training")
if input_button:
...
if input_dir:
   ...
   streamlit_log["app_main_supervised_skeletons_finetune"]["input_dir"] = input_dir
...
if save_model:
   ...
   streamlit_log["app_main_supervised_skeletons_finetune"]["save_model"] = save_model
...
streamlit_log["app_main_supervised_skeletons_finetune"]["verbose"] = verbose
...
if loadingButton and checkEmpty():
    ...
    ### Write the YAML
    streamlit_log["app_main_supervised_skeletons_finetune"]["end_time"] = datetime.datetime.now()
