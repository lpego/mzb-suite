...
from scripts.segmentation.main_raw_to_clips import main

# Configuration by declaring variables
VARIABLES = {
    "config_file": {
        "type": "file",
    ...
    "input_dir": {"type": "folder", "description": "Directory containing the raw images"},
    "output_dir": {"type": "folder", "description": "Directory where to save segmented clips"},
    "save_full_mask_dir": {"type": "folder", "description": "Directory to save full-image masks as JPG"},
...
# Logic for 2-step file selection or single step folder selector
for var, props in VARIABLES.items():
...
# Launch script if all arguments are collected
if launch_pressed: 
