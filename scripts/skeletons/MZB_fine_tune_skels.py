...
if __name__ == "__main__":
    ...
    model = MZBModel_skels(
        ...
        pretrained_network="efficientnet-b2",  # "resnet18", # resnet50 # efficientnet-b2 # mit_b1 / 2 are best
        learning_rate=1e-4,  # was e-4
        batch_size=16,
        weight_decay=0,
    ...
    # %%
    name_run = f"skel-segm-mzb-{model.architecture}-tverskyL-bodyhead-patience-long"  # f"{model.pretrained_network}"
