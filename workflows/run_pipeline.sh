...
#     --output_dir=${ROOT_DIR}/data/derived/skeletons/project_portable_flume/supervised_skeletons/skseg_${MODEL}_val_set\
#     --save_masks=${ROOT_DIR}/data/derived/project_portable_flume/skeletons/supervised_skeletons/${MODEL}/val_set_masks/ \
